...
(function ($, undefined) {
    ...
    $document.ready(function () {
        ...
        $('.main-header').imagesLoaded({
            background: true
        }, function () {
            $('.main-header-background-square').css('background-color', 'black');
            $('.main-header-background-square').css('opacity', '0.2');
        });
